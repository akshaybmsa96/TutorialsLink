...
public class CustomAdapterHomeArticle extends RecyclerView.Adapter<CustomAdapterHomeArticle.ViewHolder>
{
    ...
    public CustomAdapterHomeArticle(Context context, ArrayList<FeedTablePojo> tablePojo, Activity activity) {
    ...
    @Override
    public CustomAdapterHomeArticle.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.list_layout_home_article, parent, false);
        CustomAdapterHomeArticle.ViewHolder holder = new CustomAdapterHomeArticle.ViewHolder(view);
    ...
    @Override
    public void onBindViewHolder(CustomAdapterHomeArticle.ViewHolder holder, int position)
    {
