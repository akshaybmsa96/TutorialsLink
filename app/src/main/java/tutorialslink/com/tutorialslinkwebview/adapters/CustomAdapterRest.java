...
public class CustomAdapterRest extends RecyclerView.Adapter<CustomAdapterRest.ViewHolder>
{
    ...
    public CustomAdapterRest(Context context, ArrayList<FeedTablePojo> tablePojo, Activity activity) {
    ...
    @Override
    public CustomAdapterRest.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.list_layout_rest, parent, false);
        CustomAdapterRest.ViewHolder holder = new CustomAdapterRest.ViewHolder(view);
    ...
    @Override
    public void onBindViewHolder(CustomAdapterRest.ViewHolder holder, int position)
    {
