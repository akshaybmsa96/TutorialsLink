...
/**
 * Created by akshaybmsa96 on 21/06/18.
 */

public class CustomAdapterHomeVideo extends RecyclerView.Adapter<CustomAdapterHomeVideo.ViewHolder>
{
    ...
    public CustomAdapterHomeVideo(Context context, ArrayList<FeedTablePojo> tablePojo, Activity activity) {
    ...
    @Override
    public CustomAdapterHomeVideo.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.list_layout_home_videos, parent, false);
        CustomAdapterHomeVideo.ViewHolder holder = new CustomAdapterHomeVideo.ViewHolder(view);
    ...
    @Override
    public void onBindViewHolder(CustomAdapterHomeVideo.ViewHolder holder, int position)
    {
